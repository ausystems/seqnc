...
import Demos from './scenes/Demos.jsx';
...
export default function App() {
  useEffect(() => {
    /* pinned scenes change the page height: measure again once fonts and
       everything else have landed */
