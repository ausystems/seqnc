/* =========================================================================
   Cancel: a switch that lets go, any time, and keeps showing it.  The
   word, the switch and the check stand from the start.  The switch turns
   ...
   and the check pulses each time it lets go.
   ========================================================================= */
...
export default function Cancel({ d, className = '' }) {
  const ref = useScene((el) => {
    ...
    const tl = gsap.timeline({ repeat: -1, repeatDelay: 1.6 })
      ...
      .to(halo, { opacity: 0, scale: 1.25, duration: .6, ease: 'power2.out' }, 2.0)
